  ...
  return (
    <View style={styles.modalContainer}>
                    ...
                    <Text style={styles.labelInput}>Name : {data.nameCategory}</Text>
                     <Text style={{marginStart:24,marginTop:12,fontSize:16}}>Ngày tạo : {data.createdAt.slice(0,10)}</Text>
                     <Text style={{marginStart:24,marginTop:12,fontSize:16}}>Cập nhật gần nhất : {data.updatedAt.slice(0,10)}</Text>
